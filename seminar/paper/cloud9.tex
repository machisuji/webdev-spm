...
\include{chapters/introduction} %patrick
\include{chapters/motivation} %patrick
\include{chapters/approaches} %stephi
\include{chapters/related_work} %markus
\include{chapters/extension} %stephi: description, new workflow, ansonsten jeder seins
\include{chapters/future_work} %markus
\include{chapters/conclusion} %patrick
